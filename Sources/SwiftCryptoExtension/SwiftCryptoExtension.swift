...
public final class SwiftCryptoExtensionLocalError {
    ...
    public class RSA {
        ...
        public static let StringToDataError                 = NSError(domain: domain, code: -3)
        public static let ObjectToDataError                 = NSError(domain: domain, code: -4)
        public static let SecKeyCreateEncryptedDataError    = NSError(domain: domain, code: -5)
    }
